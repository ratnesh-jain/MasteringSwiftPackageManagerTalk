...
extension UIFont {
    static func registerFont(bundle: Bundle, fontName: String, fontExtension: String) -> Bool {
        ...
        // Here scope like `CTFontManagerScope.persistent` is not supported in ths method.
...
extension Font {
    ...
    public static func playwrite(weight: AppFont.PlayWriteWeight, fixedSize: CGFloat) -> Font {
        Font.custom(weight.name, fixedSize: fixedSize)
    }
    
    public static func playwrite(weight: AppFont.PlayWriteWeight, size: CGFloat, relativeTo: TextStyle) -> Font {
        Font.custom(weight.name, size: size, relativeTo: relativeTo)
    }
}
